            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='laoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="职称" prop="zhichengValue">
                        <el-input v-model="laoshiForm.zhichengValue"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="最大报名人数" prop="kechengRenshu">
                       <el-input v-model="ruleForm.kechengRenshu"
                                 placeholder="最大报名人数" clearable  :readonly="ro.kechengRenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="开课时间" prop="kaikeTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaikeTime" label="开课时间" prop="kaikeTime">
