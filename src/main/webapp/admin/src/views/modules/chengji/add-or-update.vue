    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系" prop="yuanxiValue">
                        <el-input v-model="xueshengForm.yuanxiValue"
            ...
            <input id="kechengId" name="kechengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考试名称" prop="chengjiName">
                       <el-input v-model="ruleForm.chengjiName"
                                 placeholder="考试名称" clearable  :readonly="ro.chengjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="考试名称" prop="chengjiName">
                           <el-input v-model="ruleForm.chengjiName"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="成绩备注" prop="chengjiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengjiContent" label="成绩备注" prop="chengjiContent">
