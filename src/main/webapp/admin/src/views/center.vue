  ...
  <div>
    ...
    >
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='laoshi'"  label='职称' prop="zhichengTypes">
                 <el-select v-model="ruleForm.zhichengTypes" disabled  placeholder='请选择职称'>
                     <el-option
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zhichengTypes)&& 'laoshi'==this.flag){
