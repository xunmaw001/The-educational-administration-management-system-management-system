    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(jiaocai !=null){
            ...
            BeanUtils.copyProperties( jiaocai , view );//把实体数据重构到view中
                ...
                //级联表
                KechengEntity kecheng = kechengService.selectById(jiaocai.getKechengId());
                if(kecheng != null){
    ...
    */
    ...
    public R save(@RequestBody JiaocaiEntity jiaocai, HttpServletRequest request){
        ...
        Wrapper<JiaocaiEntity> queryWrapper = new EntityWrapper<JiaocaiEntity>()
            .eq("kecheng_id", jiaocai.getKechengId())
            .eq("jiaocai_uuid_number", jiaocai.getJiaocaiUuidNumber())
            .eq("jiaocai_name", jiaocai.getJiaocaiName())
            .eq("jiaocai_types", jiaocai.getJiaocaiTypes())
            .eq("jiaocai_shuliang", jiaocai.getJiaocaiShuliang())
            ;
...
//                            jiaocaiEntity.setKechengId(Integer.valueOf(data.get(0)));   //课程 要改的
...
//                            jiaocaiEntity.setJiaocaiShuliang(Integer.valueOf(data.get(0)));   //教材数量 要改的
...
//                            jiaocaiEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //教材编号
                        List<JiaocaiEntity> jiaocaiEntities_jiaocaiUuidNumber = jiaocaiService.selectList(new EntityWrapper<JiaocaiEntity>().in("jiaocai_uuid_number", seachFields.get("jiaocaiUuidNumber")));
